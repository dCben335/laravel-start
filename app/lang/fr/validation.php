...
*/
    ...
    'max' => [
        ...
        'string' => 'Le champ :attribute nedoit pas comporter plus de :max caractères.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour échanger nos espaces réservés d'attributs
